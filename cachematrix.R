...
## rather than compute it repeated. So, I will try to write a pair of functions that cache the inverse of a matrix.

## assume that matrix supplied as input is always invertible.
